      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm mb-4 text-gold-200">
            ...
            <div className="flex flex-col space-y-2">
              <Input
                ...
                className="bg-navy-800 border-gold-900/50 text-gold-100 placeholder:text-gold-500/50"
              />
        ...
        <div className="border-t border-gold-900/30 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
